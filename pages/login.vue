...
<section class="section">
    ...
    <div class="card">
        ...
        <form action method="post" @submit.prevent="login">
            ...
            <div class="field">
                <div class="control">
                    <input type="password" class="input has-text-centered" v-model="account.password" placeholder="Paswword here!" required />
                </div>
            </div>

            <div class="control has-text-centered">
                <button type="submit" class="button is-dark is-rounded is-outlined is-medium is-family-primary" v-on:click="login">Log In</button>
            </div>
        </form>
    </div>
</section>
